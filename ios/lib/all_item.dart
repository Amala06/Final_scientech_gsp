                      ...
                      Container(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: () {
                            switch (array_name) {
                              case "matrix":
                                return ServerController.serverr.matrix.length -
                                    1;
                              case "soil":
                                return ServerController.serverr.street.length -
                                    1;
                              default:
                          ...
                          itemBuilder: (BuildContext context, index) {
                            switch (array_name) {
                              case "matrix":
                                rowDataVal =
                                    ServerController.serverr.matrix[index + 1];
                                break;
                              case "soil":
                                rowDataVal =
                                    ServerController.serverr.street[index + 1];
                                break;
                              default:
                                rowDataVal =
