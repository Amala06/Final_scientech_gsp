...
class StreetSmallList extends StatelessWidget {
//   @override
...
//                     }
                    ...
                    switch (array_name) {
                      case "matrix":
                        rowDataVal = ServerController.serverr.matrix[index + 1];
                        break;
                      case "street":
                        rowDataVal = ServerController.serverr.street[index + 2];
                        break;
                      default:
                        rowDataVal = ServerController.serverr.smart[index + 1];
                        break;
                    }
