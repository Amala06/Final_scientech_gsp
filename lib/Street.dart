...
import 'package:flutter/services.dart';
import 'package:my_app/street_small_list.dart';
              ...
              DrawerHeader(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/sr.png'), // Your image asset path
                    fit: BoxFit.cover,
                  ),
                ),
                child: Text(
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Discover cutting-edge smart street IoT devices. Monitor and optimize urban infrastructure, enhance traffic management, and ensure safer environments with data-driven insights and advanced technology.",
                            style: TextStyle(
                              color: Colors.white,
                            ),
              ...
              child: Stack(
                children: [
                  Positioned.fill(
                    ...
                    child: Image.asset(
                        (ServerController.serverr.street[1][2] == '0')
                          ? 'assets/bgnl.png'
                          : 'assets/bg.png',
                      // 'assets/bg.png',
                      fit: BoxFit.cover,
