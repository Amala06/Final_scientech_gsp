...
import 'package:my_app/swipe.dart';
      ...
      body: GetBuilder<ServerController>(
        builder: (controller) {
          if (controller.matrix.isEmpty) {
            ...
            controller.setArrayName(array_name);
            ...
            // Return the desired widget based on the conditions
                            return SwiperNew(arrayName: controller.arrayName);

            // return SwiperNew(arrayName: array_name,);
          }
        },
      ),
              ...
              Expanded(
                child: Padding(
                    ...
                    child: Column(children: [
                        ...
                        children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                              color: serverController.server!.running
                                  ? Colors.green[400]
                                  : Colors.red[400],
                            ),
                            padding: EdgeInsets.all(5),
                            child: Text(serverController.server!.running
                                ? "ON"
                                : "OFF"),
                          ),
                        ],
                      ...
                      Expanded(
                          child: ListView(
                        children: serverController.serverLogs
                            .map((e) => Text("$e"))
                            .toList(),
                      )),
