...
class GreenAllItem extends StatelessWidget {
  @override
                  ...
                  child: Stack(
                    children: [
                      ...
                      Container(
                        ...
                        height:
                            screenHeight, // Set the desired height for the GridView
                        margin:
                            EdgeInsets.only(top: screenHeight - 650, left: 18),
                        child: Align(
                          alignment: Alignment.topCenter,
